...
export interface IChatClient {
    ...
    send(request: chat_pb.Message, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
    send(request: chat_pb.Message, metadata: grpc.Metadata, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
    send(request: chat_pb.Message, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
}
...
export class ChatClient extends grpc.Client implements IChatClient {
    ...
    public send(request: chat_pb.Message, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
    public send(request: chat_pb.Message, metadata: grpc.Metadata, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
    public send(request: chat_pb.Message, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: Error | null, response: chat_pb.Message) => void): grpc.ClientUnaryCall;
}
